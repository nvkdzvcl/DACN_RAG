...
Mốc hiện tại tạo nền tảng xác thực và chuyển giao có người phụ trách, giúp giữ nhất quán quyền trả lời và trạng thái AI. RAG local có mô hình thật, lưu bền, bộ 72 câu TXT và 24 câu PDF/DOCX, trích câu nguồn và kiểm định. M3 chưa nghiệm thu: cần người duyệt nhãn/đáp án, nguồn và câu hỏi độc lập; xử lý ID sai, phủ định/nối tiếp và điều kiện thiếu. OCR, sentiment/SLA và LLM tool calling chưa được đánh giá. Tiếp theo hoàn thiện widget/phiên khách/realtime, Agentic RAG, kênh thứ hai và triển khai.
