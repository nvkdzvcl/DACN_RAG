...
LLM nhận tối đa bốn tin lịch sử ngắn để hiểu câu nối tiếp; tài liệu là bằng chứng cho nội dung chính sách. JSON trả về gồm đáp án, supported và citation có quote. Backend kiểm tra schema, ID nguồn và quote nguyên văn. Giữ ngưỡng retrieval 0,35 sau chẩn đoán trên dev. Citation đúng về chuỗi chưa chứng minh mọi mệnh đề trong câu trả lời đều đúng.

Sau kiểm tra quote, hệ thống gọi cùng qwen3:1.7b một lần nữa để kiểm định đáp án. Ba điều kiện phải cùng đúng: câu hỏi đủ ngữ cảnh, các nguồn liên quan nhất quán và mọi dữ kiện được quote hỗ trợ. Chỉ dẫn chèn trong nguồn không phải bằng chứng chính sách. Kiểm định nhận cả nguồn không được đáp án trích dẫn, trong giới hạn nguồn đã cấp cho model sinh. JSON kiểm định sai dẫn đến từ chối; lỗi provider được báo riêng và giữ tin khách. Cả hai lần gọi model đều nằm ngoài SQL transaction. Backend kiểm tra lại phiên bản mọi nguồn đã kiểm định trước khi lưu AI, đồng thời chặn phản hồi muộn sau handoff hoặc tin khách mới.

## Chương 6 Kết quả thực hiện

Lệnh python -m unittest discover -s app/tests -v chạy đạt 31 kiểm thử trên DB thử tách biệt. Các nhóm kiểm tra bao gồm mật khẩu/cookie, phiên hết hạn và tài khoản vô hiệu, quyền admin/agent và CSRF, giới hạn đăng nhập, dữ liệu gửi giả mạo, luồng tin nhắn/handoff, nhận tranh chấp bằng hai luồng, migration giữ dữ liệu, Inbox, nhận diện mã đơn, vector lưu bền, metadata, chống trùng, retry/xóa tài liệu, citation sai, lỗi provider, AI muộn sau tin khách mới và công thức chấm benchmark. Bổ sung kiểm tra citation đúng không vượt được kết quả kiểm định từ chối, schema kiểm định sai, đáp án phủ định có nguồn, lỗi model trong bước kiểm định giữ tin khách và nguồn không được trích dẫn bị đổi trước khi lưu AI.
...
Mốc hiện tại tạo nền tảng xác thực và chuyển giao có người phụ trách, giúp giữ nhất quán quyền trả lời và trạng thái AI. RAG local đã có mô hình thật, lưu bền, bộ 72 câu và bước kiểm định đáp án sau sinh. Công việc tiếp theo là duyệt nhãn và đáp án, xử lý các ca suy diễn/thiếu điều kiện hoặc mâu thuẫn còn lọt, giảm từ chối sai ở câu phủ định/nối tiếp hoặc quote sai dấu, bổ sung tài liệu PDF/DOCX và câu hỏi chưa xem; sau đó hoàn thiện widget/realtime/SLA, Agentic RAG, kênh thứ hai, đánh giá và triển khai.
